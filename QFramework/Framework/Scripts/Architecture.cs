...
namespace QFramework
{
    ...
    public abstract class Architecture<T> : IArchitecture where T : Architecture<T>, new()
    {
        ...
        {
            return _container.TryGet<TSystem>(out result);
        }

        public virtual TModel GetModel<TModel>() where TModel : class, IModel => _container.Get<TModel>();
        public virtual bool TryGetModel<TModel>(out TModel result) where TModel : class, IModel
        {
            return _container.TryGet<TModel>(out result);
        }

        public virtual TUtility GetUtility<TUtility>() where TUtility : class, IUtility => _container.Get<TUtility>();
        public virtual bool TryGetUtility<TUtility>(out TUtility result) where TUtility : class, IUtility
        {
            return _container.TryGet<TUtility>(out result);
        }
    ...
    public class IOCContainer
    {
        ...
        public bool TryGet<T>(out T result) where T : class
        {
            ...
            if (mInstances.TryGetValue(key, out var res))
            {
                result = res as T;
                return true;
            }
