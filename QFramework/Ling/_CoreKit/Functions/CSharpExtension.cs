...
#if UNITY_EDITOR
        [MethodAPI]
        [APIDescriptionCN("安全的范围移除列表")]
        [APIDescriptionEN("安全的范围移除列表")]
        [APIExampleCode(@"list.SafeRemoveRange(index, count)")]
#endif
        public static void SafeRemoveRange<T>(this List<T> list, int index, int count)
        {
...
#if UNITY_EDITOR
        [MethodAPI]
        [APIDescriptionCN("将字典值转换为列表")]
        [APIDescriptionEN("将字典值转换为列表")]
        [APIExampleCode(@"dict.ConvertValuesToList()")]
#endif
...
#if UNITY_EDITOR
        [MethodAPI]
        [APIDescriptionCN("将字典键转换为列表")]
        [APIDescriptionEN("将字典键转换为列表")]
        [APIExampleCode(@"dict.ConvertKeysToList()")]
#endif
